...
LITEOS_CPU_OPTS         += -march=rv32imfc_zicsr
else
LITEOS_CPU_OPTS         += -march=rv32imc_zicsr
endif
else
LITEOS_CPU_OPTS         += -march=rv32imc_zicsr
endif
...
ARCH_C_OPT += -mabi=ilp32 -falign-functions=2 -fno-optimize-strlen -freorder-blocks-algorithm=simple -fno-schedule-insns

ARCH_CXX_OPT += -mabi=ilp32  \
                -falign-functions=2 -fno-optimize-strlen -freorder-blocks-algorithm=simple -fno-schedule-insns

ARCH_ASM_OPT += -x assembler-with-cpp -mabi=ilp32
